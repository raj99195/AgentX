    ...
    <div className="page-wrap">
      <div style={{ display:'flex', alignItems:'start', justifyContent:'space-between', marginBottom:'20px' }}>
        <div>
          ...
          <p style={{ fontSize:'12px', color:'#555', marginTop:'4px' }}>AI-managed performance on BotChain</p>
        </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px', marginBottom:'20px' }}>
        {[
          {
            label:'Total Value',
            val: isConnected ? `${total.toFixed(4)} ${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'}` : '—',
            sub: isConnected ? `≈ $${totalUSD}` : 'Connect wallet'
          },
          {
            label:'Wallet Balance',
            val: isConnected ? `${mnt.toFixed(4)} ${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'}` : '—',
            sub: 'Available balance'
          },
          {
            label:'Vault Balance',
            val: isConnected ? `${vault} ${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'}` : '—',
            sub: 'In AgentX Vault'
          },
          {
            label:`${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'} Price`,
      ...
      {!isConnected ? (
        ...
        <>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'14px', marginBottom:'14px' }}>
            ...
            <div className="card">
              <div className="section-header">
                ...
                <span style={{ fontSize:'11px', color:'#888' }}>Live on BotChain</span>
              </div>
              ...
              {total > 0 ? (
                <>
                  <div className="bar-row">
                    <span className="bar-label">BOT Wallet</span>
                  ...
                  <div className="bar-row">
                    <span className="bar-label">BOT Vault</span>
                    <div className="bar-track">
                  ...
                  <div style={{ marginTop:'12px', paddingTop:'12px', borderTop:'0.5px solid rgba(255,255,255,0.06)' }}>
                    ...
                    <div style={{ fontSize:'12px', color:'#888', background:'rgba(255,255,255,0.03)', padding:'10px', borderRadius:'8px', borderLeft:'2px solid rgba(255,255,255,0.15)' }}>
                      {agentNarrative ? agentNarrative.slice(0, 120) + '...' : 'AgentX suggests depositing more BOT into vault for agent-managed yield optimization'}
                    </div>
                  </div>
                </>
              ) : (
          ...
          {/* Live BotChain DEX Pools */}
          {pools.length > 0 && (
            <div className="card" style={{ marginBottom:'14px' }}>
              <div className="section-header" style={{ marginBottom:'12px' }}>
                <div className="card-label" style={{ margin:0 }}>Live Yield Opportunities</div>
                <span style={{ fontSize:'10px', color:'#555' }}>BotChain DEX · Live</span>
              </div>
          ...
          <div className="card">
            <div className="section-header">
              ...
              <span style={{ fontSize:'11px', color:'#444' }}>Managed by AgentX agents</span>
            </div>
            <div style={{ overflowX:'auto' }}>
              <table className="data-table">
                <thead>
                ...
                <tbody>
                  <tr>
                    <td style={{ color:'#fff', fontWeight:600 }}>BOT (Wallet)</td>
                  ...
                  <tr>
                    <td style={{ color:'#fff', fontWeight:600 }}>BOT (Vault)</td>
