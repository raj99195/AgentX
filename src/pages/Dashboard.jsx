      ...
      try {
        ...
        if (mktRes.success) {
          ...
          if (mktRes.data?.market?.mntChange24h < -5)
            found.push({ type: 'MARKET_CRASH', msg: `${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'} down ${Math.abs(mktRes.data.market.mntChange24h).toFixed(1)}% today` });
          setAnomalies(found);
        }
    ...
    try {
      const result = await runMasterMind(goal, {
        ...
        onChainHire: async (masterId, subId, payment) => {
          ...
          addToFeed(`Agent #${subId} hired by Agent #${masterId} — ${payment} ${import.meta.env.VITE_NATIVE_TOKEN || "BOT"}`, hash);
        ...
        onChainPay: async (agentId, amount) => {
          ...
          addToFeed(`Agent #${agentId} paid ${amount} ${import.meta.env.VITE_NATIVE_TOKEN || "BOT"}`, hash);
          return hash;
        },
        ...
        onVaultDeposit: async (amount) => {
          ...
          addToFeed(`Vault deposit: ${amount} ${import.meta.env.VITE_NATIVE_TOKEN || "BOT"}`, hash);
          return hash;
        },
      });
  ...
  const METRICS = [
    {
      ...
      sub: isConnected ? `${import.meta.env.VITE_NATIVE_TOKEN || 'BOT'} $${mntPrice.toFixed(4)} (${mntChange >= 0 ? '+' : ''}${mntChange.toFixed(2)}%)` : 'Connect wallet',
      icon: '💼'
    },
    { label: 'Active Agents', value: String(totalAgents || 0), sub: `${loopState?.cycleCount || 0} cycles run`, icon: '🤖' },
    {
      label: 'Vault Balance',
      value: isConnected ? `${vaultBalance} BOT` : '—',
      sub: isConnected ? 'In AgentX Vault' : 'Connect wallet',
      icon: '◈'
    },
    {
      label: 'Goal Progress',
    ...
    <div className="page-wrap">
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-sub">Autonomous AI Agent Economy</div>
          <div className="hero-title">AgentX</div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 300px', gap:'16px' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
          ...
          {/* Goal + AI */}
          <div className="card">
            <div className="card-label">Your Goal — AgentX AI</div>
            ...
            <div className="goal-input-wrap">
              ...
              <textarea value={goal} onChange={e => setGoal(e.target.value)}
                ...
                placeholder="Tell AgentX your financial goal..."
                disabled={isRunning} />
            ...
            <div className="card">
              ...
              {marketData?.pools?.[0] && (
                <div style={{ display:'flex', gap:'8px', marginBottom:'10px', flexWrap:'wrap' }}>
                  ...
                  <div style={{ padding:'6px 10px', background:'rgba(255,255,255,0.03)', borderRadius:'6px', fontSize:'11px' }}>
                    <span style={{ color:'#444' }}>BotChain TVL: </span>
            ...
            {isConnected ? (
              <div>
                <div className="bar-row">
                  <span className="bar-label">{import.meta.env.VITE_NATIVE_TOKEN || 'BOT'}</span>
